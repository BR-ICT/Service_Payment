            ...
            loadData: function (filter) {
                ...
                $.ajax({
                    ...
                    response = $.grep(response, function (item) {
                        return((!filter.RSTATUS || item.RSTATUS && item.RSTATUS.indexOf(filter.RSTATUS) > -1) &&
                                (!filter.RPAYMENTNO || item.RPAYMENTNO && item.RPAYMENTNO.indexOf(filter.RPAYMENTNO) > -1) &&
                                (!filter.ROWNO || item.ROWNO && item.ROWNO.indexOf(filter.ROWNO) > -1) &&
                                (!filter.RSERVICE || item.RSERVICE && item.RSERVICE.indexOf(filter.RSERVICE) > -1) &&
                                ...
                                (!filter.RPREMARK || item.RPREMARK && item.RPREMARK.indexOf(filter.RPREMARK) > -1) &&
                                (!filter.RDEDUCTDESC || item.RDEDUCTDESC && item.RDEDUCTDESC.indexOf(filter.RDEDUCTDESC) > -1) &&
...
//                alert(item.RDTOTA_KGS);
        ...
        fields: [
            ...
            {title: "ROW No.", name: "ROWNO", css: "limitext", type: "text", editing: false, align: "left", width: 70},
            {title: "Service No.", name: "RSERVICE", css: "limitext", type: "text", editing: false, align: "left", width: 70},
            ...
            {title: "PAYMENT REMARK", name: "RPREMARK", css: "limitext", type: "text", editing: false, align: "left", width: 100},
            {title: "Deduct Desc", name: "RDEDUCTDESC", css: "limitext", type: "text", editing: false, align: "right", width: 100},
